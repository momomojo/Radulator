  ...
  fields: [
    ...
    // SECTION 2: VASCULAR INVASION & METASTASIS
    {
      ...
      opts: [
        ...
        {
          value: "portal_segmental",
          label: "Portal vein - segmental/sectoral",
        },
    ...
    // SECTION 3: PERFORMANCE STATUS
    {
      ...
      opts: [
        ...
        {
          value: "1",
          label: "1 - Restricted in strenuous activity, ambulatory",
        },
        {
          value: "2",
          label: "2 - Ambulatory, self-care capable, unable to work",
        },
  ...
  compute: (vals) => {
    ...
    if (ecog > 2 || (cpClass === "C" && transplant_candidate !== "yes")) {
      ...
      if (cpClass === "C" && transplant_candidate !== "yes") {
        ...
        details +=
          "decompensated cirrhosis (Child-Pugh C) without transplant option";
      }
    }
    // Check for Stage C criteria (advanced)
    else if (vascular_invasion !== "none" || extrahepatic_spread !== "none") {
      bclcStage = "C";
      treatment =
        "Systemic therapy: Atezolizumab + Bevacizumab (1st line); Sorafenib or Lenvatinib (alternatives); Regorafenib, Cabozantinib (2nd line)";
    ...
    // Stage 0, A, or B - depends on tumor burden
      ...
      if (
        ...
        bclcStage = "0";
        treatment =
          "Resection or ablation (RFA/MWA) preferred; TACE if ablation not feasible";
        prognosis = "Median survival: >5 years (5-year survival: 75%)";
        details =
          "Very early stage: Single tumor ≤2 cm, ECOG 0, preserved liver function";
      }
      // Stage A: Single tumor (any size) OR up to 3 tumors ≤3 cm each, ECOG 0
        ...
        bclcStage = "A";
        treatment =
          "Resection or ablation; Liver transplant if high recurrence risk or multiple tumors; TACE as alternative";
      ...
      // Stage B: Multifocal beyond Stage A criteria, ECOG 0
        ...
        bclcStage = "B";
        treatment =
          "TACE (for well-defined nodules); Systemic therapy (for diffuse/extensive disease); Liver transplant (if extended criteria met + downstaging)";
      ...
      // Fallback for ECOG 1-2 without vascular invasion/metastasis
        ...
        bclcStage = "B-C";
        treatment =
          "Consider TACE or systemic therapy based on tumor burden and symptoms";
        prognosis =
          "Median survival: 2-3 years depending on performance status";
        details =
          "Borderline intermediate-advanced: No vascular invasion but impaired performance status (ECOG 1-2)";
      }
    }
