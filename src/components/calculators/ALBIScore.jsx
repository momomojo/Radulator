...
Note: ALBI complements but does not replace Child-Pugh in BCLC staging.`,
  ...
  compute: ({ unit_system = "SI", albumin = 0, bilirubin = 0 }) => {
    ...
    if (albiScore <= -2.60) {
      ...
      prognosis = "Grade 1 patients have the best prognosis. Median survival in original cohort: 85.6 months. Suitable for curative therapies (resection, ablation, transplant) and all systemic treatments.";
    } else if (albiScore <= -1.39) {
      albiGrade = 2;
      gradeInterpretation = "Intermediate liver function - moderately compensated";
      prognosis = "Grade 2 patients have intermediate prognosis. Median survival in original cohort: 23.1 months. May be suitable for locoregional therapies (TACE, TARE) and systemic treatments with monitoring.";
    } else {
      albiGrade = 3;
      gradeInterpretation = "Worst liver function - poorly compensated";
      prognosis = "Grade 3 patients have the poorest prognosis. Median survival in original cohort: 6.6 months. Treatment options limited; consider best supportive care or clinical trials. Systemic therapy requires careful assessment of liver reserve.";
    }
