...
test.describe('MELD-Na Calculator', () => {
  ...
  test.describe('Visual and UI Tests', () => {
    test('should display calculator with proper layout', async ({ page }) => {
      // Check header
      await expect(page.locator('h2')).toContainText('MELD-Na Score');
      await expect(page.locator('text=Model for End-Stage Liver Disease')).toBeVisible();

      // Check info section
      await expect(page.locator('text=The MELD-Na score predicts')).toBeVisible();
      await expect(page.locator('text=Interpretation guides allocation priority')).toBeVisible();
      ...
      await expect(page.locator('label:has-text("Dialysis ≥2 times")')).toBeVisible();
  ...
  test.describe('Basic MELD Score Calculations', () => {
    ...
    test('should calculate moderate MELD score (10-19)', async ({ page }) => {
      ...
      const meldScore = await page.locator('text=/MELD Score: \\d+/').textContent();
  ...
  test.describe('MELD-Na Sodium Correction', () => {
    test('should apply sodium correction when MELD > 11', async ({ page }) => {
      ...
      const meldText = await page.locator('text=/MELD Score: \\d+/').textContent();
      const meldNaText = await page.locator('text=/MELD-Na Score: \\d+/').textContent();
    ...
    test('should NOT apply sodium correction when MELD <= 11', async ({ page }) => {
    ...
    test('should cap sodium at 125 mEq/L for MELD-Na calculation', async ({ page }) => {
      await page.fill('input[id="creatinine"]', '2.0');
      ...
      await expect(page.locator('text=Sodium set to lower bound of 125 mEq/L')).toBeVisible();
    });

    test('should cap sodium at 137 mEq/L for MELD-Na calculation', async ({ page }) => {
      await page.fill('input[id="creatinine"]', '2.0');
      await page.fill('input[id="bilirubin"]', '4.0');
      await page.fill('input[id="inr"]', '1.8');
      ...
      await expect(page.locator('text=Sodium set to upper bound of 137 mEq/L')).toBeVisible();
    });
  });

  test.describe('Dialysis Adjustments', () => {
    test('should set creatinine to 4.0 when dialysis is checked', async ({ page }) => {
      await page.fill('input[id="creatinine"]', '1.5');
      await page.fill('input[id="bilirubin"]', '3.0');
      await page.fill('input[id="inr"]', '1.5');
      await page.fill('input[id="sodium"]', '135');
      ...
      await expect(page.locator('text=Creatinine set to 4.0 mg/dL (dialysis')).toBeVisible();
    });

    test('should override high creatinine with dialysis value', async ({ page }) => {
  ...
  test.describe('Lower Bound Adjustments', () => {
    test('should set creatinine lower bound to 1.0', async ({ page }) => {
      ...
      await expect(page.locator('text=Creatinine set to lower bound of 1.0 mg/dL')).toBeVisible();
    });
    ...
    test('should set bilirubin lower bound to 1.0', async ({ page }) => {
      ...
      await expect(page.locator('text=Bilirubin set to lower bound of 1.0 mg/dL')).toBeVisible();
    });
    ...
    test('should set INR lower bound to 1.0', async ({ page }) => {
      ...
      await expect(page.locator('text=INR set to lower bound of 1.0')).toBeVisible();
    });
  });

  test.describe('Upper Bound Adjustments', () => {
    test('should cap creatinine at 4.0 (without dialysis)', async ({ page }) => {
      ...
      await expect(page.locator('text=Creatinine capped at 4.0 mg/dL')).toBeVisible();
    });
    ...
    test('should cap MELD score at minimum of 6', async ({ page }) => {
      ...
      await expect(page.locator('text=MELD score capped at minimum of 6')).toBeVisible();
    });
  ...
  test.describe('Transplant Eligibility Interpretation', () => {
    test('should suggest monitoring for MELD-Na < 15', async ({ page }) => {
      ...
      await expect(page.locator('text=Monitor closely; transplant evaluation if disease progresses')).toBeVisible();
    });

    test('should indicate transplant candidacy for MELD-Na 15-24', async ({ page }) => {
      await page.fill('input[id="creatinine"]', '2.0');
      await page.fill('input[id="bilirubin"]', '3.0');
      ...
      await expect(page.locator('text=Patient meets criteria for liver transplant evaluation')).toBeVisible();
      await expect(page.locator('text=Candidate for transplant listing')).toBeVisible();
    });

    test('should indicate high priority for MELD-Na >= 25', async ({ page }) => {
      ...
      await expect(page.locator('text=Patient meets criteria for liver transplant evaluation')).toBeVisible();
      await expect(page.locator('text=High priority for transplantation')).toBeVisible();
    });
  });
  ...
  test.describe('Input Validation', () => {
    test('should show error for missing inputs', async ({ page }) => {
      ...
      await expect(page.locator('text=Please enter all required values')).toBeVisible();
    });

    test('should show error for creatinine out of range (too low)', async ({ page }) => {
      ...
      await expect(page.locator('text=Creatinine must be between 0.1 and 15.0 mg/dL')).toBeVisible();
    });

    test('should show error for creatinine out of range (too high)', async ({ page }) => {
    ...
    test('should show error for bilirubin out of range', async ({ page }) => {
      ...
      await expect(page.locator('text=Bilirubin must be between 0.1 and 50.0 mg/dL')).toBeVisible();
    });
    ...
    test('should show error for INR out of range', async ({ page }) => {
      ...
      await expect(page.locator('text=INR must be between 0.8 and 10.0')).toBeVisible();
    });

    test('should show error for sodium out of range (too low)', async ({ page }) => {
      await page.fill('input[id="creatinine"]', '1.5');
      await page.fill('input[id="bilirubin"]', '2.0');
      await page.fill('input[id="inr"]', '1.5');
      ...
      await expect(page.locator('text=Sodium must be between 110 and 160 mEq/L')).toBeVisible();
    });

    test('should show error for sodium out of range (too high)', async ({ page }) => {
      await page.fill('input[id="creatinine"]', '1.5');
      await page.fill('input[id="bilirubin"]', '2.0');
      await page.fill('input[id="inr"]', '1.5');
  ...
  test.describe('Edge Cases and Special Scenarios', () => {
    ...
    test('should handle borderline MELD score (exactly 11)', async ({ page }) => {
    ...
    test('should handle all lower bounds simultaneously', async ({ page }) => {
      ...
      await expect(page.locator('text=Creatinine set to lower bound')).toBeVisible();
      await expect(page.locator('text=Bilirubin set to lower bound')).toBeVisible();
  ...
  test.describe('Reference Links', () => {
    ...
    test('should have clickable reference links', async ({ page }) => {
      const firstLink = page.locator('section:has-text("References") a').first();
      await expect(firstLink).toHaveAttribute('href', /https?:\/\/.+/);
      await expect(firstLink).toHaveAttribute('target', '_blank');
    });

    test('should include key references', async ({ page }) => {
      await expect(page.locator('text=Kamath PS et al. Hepatology 2001')).toBeVisible();
      await expect(page.locator('text=Kim WR et al. Gastroenterology 2008')).toBeVisible();
  ...
  test.describe('Clinical Workflow', () => {
    ...
    test('should handle recalculation with different values', async ({ page }) => {
      // First calculation
      await page.fill('input[id="creatinine"]', '1.5');
      await page.fill('input[id="bilirubin"]', '2.0');
      await page.fill('input[id="inr"]', '1.3');
      ...
      const firstResult = await page.locator('text=/MELD Score: \\d+/').textContent();
      ...
      const secondResult = await page.locator('text=/MELD Score: \\d+/').textContent();
