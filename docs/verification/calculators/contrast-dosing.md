...
| UNCAPPED-HALF-MG | 50.02125 kg, 175 cm, routine | Original target `50.02125 × 400 = 20,008.5 mg I`, displayed as 20,009 mg I. Preserve that original uncapped expression: dividing by concentration and multiplying again introduces a floating-point rounding regression. |
...
- CONTRAST-1 review correction: `5a91c273835850d60fa0cf83fb08352715794121` preserves the original uncapped total and adds the half-mg regression (6/6 focused cases passed). Actual clipboard reading is Chromium-only; rendered assertions remain cross-browser. Chromium cap tests passed 2/2 and WebKit rendered cap test passed 1/1; Firefox could not launch locally because its executable was unavailable. No Firefox pass is claimed.
- CONTRAST-1 owner code/arithmetic acceptance and separate GPT-6 Astra peer review: accepted for this bounded report correction on 2026-09-07. Owner reran the six actual-export computation tests successfully. This does not accept the broader protocol policies listed above.
- Full final-candidate suite and independent signed clinical release reviews: pending; required before merge. This record is not a release authorization.
